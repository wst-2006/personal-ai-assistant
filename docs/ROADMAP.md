...
- Monorepo, configuration, database guard, and migration baseline
- Form and confirmed natural-language task creation
...
- Verified Huawei Calendar integration
- Native Android enhancements and offline synchronization
- User-imported file parsing and more visual game extensions
