        ...
        messages: [
          {
            ...
            content: [
              ...
              "每个日对象必须有 nutritionDirection、proteinRangeGrams({minimum:90,maximum:120})、plateGuidance(1-5 条)、seasonalVegetables(1-6 条)、seasonalGuidance(string|null)、seasonalPoem({title,author,excerpt,relevance}|null)、movement({category:'strength|volleyball|running|cycling|recovery|rest',durationMinutes:{minimum,maximum},intensity:'rest|low|moderate|high',highIntensity:boolean,safetyReminder})。",
